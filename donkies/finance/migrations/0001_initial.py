    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share_of_change', models.IntegerField(default=0, help_text='For debt accounts in percentage. Share of "change" between debt accounts.The total share of all accounts should be 100%.')),
            ],
            options={
